...
import com.opcua.server.server.types.CustomStructType;
import com.opcua.server.server.types.CustomUnionType;
...
public class ExampleNamespace extends ManagedNamespaceWithLifecycle {
    ...
    private final Logger logger = LogManager.getLogger(ExampleNamespace.class);
